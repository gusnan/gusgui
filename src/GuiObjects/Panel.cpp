 ...
 *
 */
Panel::Panel(Rect rect,bool transparentFrame) : GuiObject(rect), m_GuiList(0), m_DrawFrame(false), m_DrawBackground(false), m_TransparentFrame(transparentFrame)
{
 ...
 *
 */
void Panel::addGuiObject(GuiObject *guiObject)
{
